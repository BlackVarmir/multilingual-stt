"""Fine-tuning Whisper з LoRA — версія для ноутбука (P1000 4GB VRAM)"""
...
def main():
    # Параметри — шляхи для ноутбука
    model_name = "openai/whisper-large-v3-turbo"
    output_dir = "models/whisper-uk-lora"
    data_dir = "data/prepared/common_voice_uk"
    ...
    # LoRA — менший r для економії пам'яті
    ...
    if len(test_ds) > 500:
        ...
        print(f"Using 500 random test samples for eval")
    ...
    # Тренування
    print("Starting LoRA training (local)...")
    print("batch=1, accum=32, gradient_checkpointing=ON")
    trainer.train()
